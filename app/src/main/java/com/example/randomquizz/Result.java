    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btMainMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Result.this,StoryTelling.class);
        ...
        int score = intent.getIntExtra("Your Score",0);
        int totalQuestion = intent.getIntExtra("Total Question",0);
        int correctQues = intent.getIntExtra("Good Answer",0);
        int wrongQues = intent.getIntExtra("False Answer",0);
